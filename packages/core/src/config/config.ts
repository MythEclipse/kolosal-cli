...
import { ScaffoldProjectTool } from '../tools/scaffold-project.js';
import { DetectFrameworkTool } from '../tools/detect-framework.js';
import { AutoDetectDependenciesTool } from '../tools/auto-detect-dependencies.js';
import { ResolveConflictsTool } from '../tools/resolve-conflicts.js';
...
import { ManageDependenciesTool } from '../tools/manage-dependencies.js';
import { RunBuildTool } from '../tools/run-build.js';
import { GitStatusTool, GitCommitTool, GitBranchTool, GitLogTool } from '../tools/git-tools.js';
import { DocumentationTool } from '../tools/documentation.js';
import { ContainerTool } from '../tools/container.js';
import { DeploymentTool } from '../tools/deployment.js';
import { EnvironmentTool } from '../tools/environment.js';
import { OptimizationTool } from '../tools/optimization.js';
import { ArchitectureTool } from '../tools/architecture.js';
import { CollaborationTool } from '../tools/collaboration.js';
...
export class Config {
  ...
  async createToolRegistry(): Promise<ToolRegistry> {
    ...
    registerCoreTool(VerifyTaskTool, this);
    registerCoreTool(ExitPlanModeTool, this);
    registerCoreTool(WebFetchTool, this);
    registerCoreTool(ScaffoldProjectTool, this);
    registerCoreTool(DetectFrameworkTool, this);
    registerCoreTool(AutoDetectDependenciesTool, this);
    registerCoreTool(ResolveConflictsTool, this);
    registerCoreTool(ManageDependenciesTool, this);
    registerCoreTool(RunBuildTool, this);
    registerCoreTool(GitStatusTool, this);
    registerCoreTool(GitCommitTool, this);
    registerCoreTool(GitBranchTool, this);
    registerCoreTool(GitLogTool, this);
    registerCoreTool(DocumentationTool, this);
    registerCoreTool(ContainerTool, this);
    registerCoreTool(DeploymentTool, this);
    registerCoreTool(EnvironmentTool, this);
    registerCoreTool(OptimizationTool, this);
    registerCoreTool(ArchitectureTool, this);
    registerCoreTool(CollaborationTool, this);
